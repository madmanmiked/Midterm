...
';
	...
	while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
			echo '<tr><td align="left">' . $row['state'] . '</td><td align="left">' . $row['name'] .  '</td><td align="left">' . $row['email']  .'</td><td align="left">' . '<a href="incidents.php?id=' . $row['name'] . '">View Customer incidents</a>'. '</td><td align="left">' . '<a href="registrations.php?id=' . $row['name'] . '">View Products by Customer</a>'. '</td></tr> ' ;
